 ...
 * Anthony A----------
 *
 * HTML file that includes a form for the user to update a record in the game collection database
 */
...
<html>
    ...
    <head>
        ...
        <title>Update Video Game Record</title>
        <meta charset="UTF-8">
        ...
        <div id="dtbDisplay">
            <br>
                <form action="updateGame.php" method="POST">
                    ...
                    <br><br>
                    <button type="submit" class="but">UPDATE GAME</button>
                </form>
            <br>
